document.addEventListener("DOMContentLoaded", () => {
  //console.log('DOM cargado');
      ...
      // OPT Low Score - Descargar Validapp
      document.getElementById("descargarValidapp").addEventListener("click", function() {
        // Obtener el botón "Listo" y eliminar la clase "disabled"
        document.getElementById("listoValidapp").classList.remove("disabled");
    });
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                ...
                <div class="text-center p-2 d-block d-md-none">
                    ...
                    <p><b>Amelia</b>, al aplicar a Uepa Cuotas, reservarás tus boletas para Morat pagando hoy únicamente
                    la primera cuota.</p>
            ...
            <div class="modal-body pt-0">
                ...
                <form id="otpNewForm" action="#!">
                    ...
                    <div class="step">
                        ...
                        <div class="mb-3">
                            <input id="numeroCedula1" class="form-control bg-light" type="tel" placeholder="Confirmar Cédula" oninput="this.className = ''" name="cedula">
                        </div>
                        <div class="mb-3">
                    ...
                    <!-- Contenedor para la leyenda de OTP inválido -->
                    <div class="text-center w-100 mb-3">
                        <small class="text-danger" id="otpInvalidMessage" style="display: none;">Código OTP inválido, intenta nuevamente.</small>
                    </div>

                    <div class="text-center w-100 mb-3">
                        <small>¿No recibiste tu código?, <a href="#">Reenviar</a></small>
                    </div>
                        ...
                        <div class="text-center w-100">
                            ...
                            <button class="btn btn-primary btn-lg px-5 rounded-5" type="button" id="nextBtn" onclick="validateOTPAndProceed()">Continuar</button>
                        </div>
                    ...
                    <div class="step">
                        ...
                        <div class="mb-3">
                            <input class="form-control bg-light disabled is-valid" type="text" value="Amelia Núñez" placeholder="Nombre" oninput="this.className = ''" name="fullname" disabled>
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <div class="text-center p-2">
                    ...
                    <p><b>Amelia</b>, unos pasos más y estaremos listos.</p>
                    ...
                    <div class="w-100 mb-3 text-center">
                        <p class="mb-1">Tu código de aplicación es:</p>
                        <p class="h4 text-primary my-0">1234</p>
                    </div>

                    <a id="descargarValidapp" target="_blank" href="https://play.google.com/store/apps/details?id=va.credoapply&hl=es_MX" class="btn btn-outline-success btn-sm px-5 rounded-5">Descargar Validapp</a>
            ...
            <div class="modal-footer text-center"> 
                ...
                <p>Al finalizar el proceso en Validapp regresa a esta página y pulsa el botón "Listo" para continuar.</p>

                <div class="text-center w-100">
                    <button id="listoValidapp" type="button" class="btn btn-primary btn-lg px-5 my-3 rounded-5 disabled">Listo</button>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <div class="text-center p-2">
                    ...
                    <p><b>Amelia</b>, en esta ocasión no tenemos un plan de pagos disponible que se ajuste a tus necesidades.</p>
                    <p>De todas formas aún tienes la oportunidad de pagar las boletas que seleccionaste por completo y no perderlas.</p>
                </div>
            ...
            <div class="modal-footer"> 
                <div class="text-center w-100">
                    <button type="button" class="btn btn-primary btn-lg px-5 my-3 rounded-5">Reservar mis boletas</button>
                </div>
            </div>
        </div>
        </div>
...
function validateOTPAndProceed() {
  ...
  // Verificar si el OTP es correcto (en este caso '1234')
  if (otp !== "1234") {
    // Mostrar mensaje de error si el OTP es incorrecto
    document.getElementById("otpInvalidMessage").style.display = "block";
  } else {
    // Ocultar el mensaje de error si el OTP es correcto
    document.getElementById("otpInvalidMessage").style.display = "none";

    // Llamar a la función que maneja el flujo (nextPrev)
    nextPrev(1); // Continúa el flujo solo si el OTP es correcto
  }
}
